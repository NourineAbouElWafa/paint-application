...
final static BasicStroke t=new BasicStroke(3);
    ...
    public Rectangle(int x1, int y1, int x2, int y2, Color color, boolean selected , boolean filled) {
    ...
    public void draw(Graphics g) {
            ...
            else if(this.isFilled()==true)
        {
            g.fillRect(getX1(), getY1(), getX2() - getX1(), getY2() - getY1());
              ...
              if(this.isSelected()==true){
                  g2.setStroke(dashed);
                g.drawRect(getX1()-3, getY1()-3,Math.abs(getX2()-getX1())+6 , Math.abs(getY2()-getY1())+6);
             ...
             else if(this.isFilled()==true)
        {
            g.fillRect(getX2(), getY2(), Math.abs(getX2() - getX1()), Math.abs(getY2() - getY1()));
             ...
             if(this.isSelected()==true){
                  g2.setStroke(dashed);
                g.drawRect(getX2()-3, getY2()-3,Math.abs(getX2()-getX1())+6 , Math.abs(getY2()-getY1())+6);
                g2.setStroke(defaultStroke);
            }
            ...
            else if(this.isFilled()==true)
        {
            g.fillRect(getX2(), getY1(), Math.abs(getX2() - getX1()), Math.abs(getY2() - getY1()));
              ...
              if(this.isSelected()==true){
                  g2.setStroke(dashed);
                g.drawRect(getX2()-3, getY1()-3,Math.abs(getX2()-getX1())+6 , Math.abs(getY2()-getY1())+6);
                g2.setStroke(defaultStroke);
            }
            ...
            else if(this.isFilled()==true)
        {
            g.fillRect(getX1(), getY2(), Math.abs(getX2() - getX1()), Math.abs(getY2() - getY1()));
             ...
             if(this.isSelected()==true){
                 g2.setStroke(dashed);
                g.drawRect(getX1()-3, getY2()-3,Math.abs(getX2()-getX1())+6 , Math.abs(getY2()-getY1())+6);
                g2.setStroke(defaultStroke);
