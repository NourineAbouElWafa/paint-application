...
final static BasicStroke t=new BasicStroke(3);
    ...
    public triangle(int x1, int y1, int x2, int y2, Color color, boolean selected) {
        super(x1, y1, x2, y2, color, selected);
    }
    
    public triangle(int x1, int y1, int x2, int y2, Color color, boolean selected, boolean filled) {
    ...
    public void draw(Graphics g) {
        ...
        g.drawPolygon(new int []{getX1(),getX2(),getX1()}, new int[]{getY1(),getY2(),getY2()}, 3);
        }else if(this.isFilled()==true)
        {
            g.fillPolygon(new int []{getX1(),getX2(),getX1()}, new int[]{getY1(),getY2(),getY2()}, 3);
        }
          if(this.isSelected()==true){
                if (getX1()< getX2() && getY1() < getY2()) {
                     g2.setStroke(dashed);
                    g.drawRect(getX1()-3, getY1(), (getX2()- getX1())+6, (getY2() - getY1())+3);
                    g2.setStroke(defaultStroke);
                } else if (getX1() > getX2() && getY1() > getY2()) {
                     g2.setStroke(dashed);
                    g.drawRect(getX2()-3, getY2(), Math.abs(getX2() - getX1())+6, Math.abs(getY2() - getY1())+3);
                    g2.setStroke(defaultStroke);
                ...
                { g2.setStroke(dashed);
                    g.drawRect(getX2()-3, getY1(), Math.abs(getX2() - getX1())+6, Math.abs( getY2() - getY1())+3);
                     g2.setStroke(defaultStroke);
                }
                
                else if(getX2()>getX1() &&  getY2()<getY1()){
                     g2.setStroke(dashed);
                    g.drawRect(getX1()-3,  getY2(), Math.abs(getX2() - getX1())+6, Math.abs( getY2() - getY1())+3);
                 g2.setStroke(defaultStroke);
